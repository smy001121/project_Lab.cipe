	...
	<div class="category">
		<div class="recipeContainer">
					...
					<div class="modal-content" id="writeForm">
						<form>
							...
							<div class="modal-header">
								<h5 class="modal-title" id="writeModalLabel">일식 레시피 등록</h5>
			...
			<div class="recipesCard">
				<c:forEach var="recipe" items="${japaneseList}">
					<c:choose>
						<c:when test="${recipe.recipe_category == 'japaneseFood'}">
									...
									<div class="modal fade" id="staticBackdrop${recipe.recipe_id}"
										...
										<div
											...
											<div class="modal-content">
												...
												<textarea readonly cols="50" rows="5" class="card-text">${recipe.recipe_ingredients}</textarea>
												<h4 class="cardH4">레시피</h4>
												<textarea readonly cols="50" rows="15" class="modal-body recipe_text">${recipe.recipe_text}</textarea>
													...
													<div class="mb-3">
														...
														<div class="checkboxs">
															<label>한식<input type="checkbox"
																...
																type="checkbox" class="checkedCategory"
																name="recipe_category" value="chineseFood"
																onClick="countCheck(this)" /></label> <label>일식<input
																type="checkbox" class="checkedCategory"
																name="recipe_category" value="japaneseFood" checked="on"
