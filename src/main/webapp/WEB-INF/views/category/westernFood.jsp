	...
	<div class="category">
		<div class="recipeContainer">
					...
					<div class="modal-content" id="writeForm">
						<form>
							...
							<div class="modal-header">
								<h5 class="modal-title" id="writeModalLabel">양식 레시피 등록</h5>
			...
			<div class="recipesCard">
				<c:forEach var="recipe" items="${westernList}">
					<c:choose>
						<c:when test="${recipe.recipe_category == 'westernFood'}">
													...
													<div class="mb-3">
														...
														<div class="checkboxs">
															<label>한식<input type="checkbox"
																...
																name="recipe_category" value="westernFood" checked="on"
